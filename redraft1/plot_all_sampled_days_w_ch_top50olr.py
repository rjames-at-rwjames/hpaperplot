...
# NOW WITH FILTER TO PICK BEST 50 in terms of OLR intensity
...
howolr='top50olr' # type of OLR mean filter
    ...
    for m in range(nmod):
        ...
        for b in range(len(edts)):
            ...
            if mon >= f_seas[jj] or mon <= l_seas[jj]:
                ...
                if cX > w_cen[jj] and cX < e_cen[jj]:
